...
public class CheckInRecycleAdapter extends
		RecyclerView.Adapter<CheckInRecycleAdapter.CheckinViewHolder> {
	...
	public CheckInRecycleAdapter() {
		super();
		mItems = new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9",
				"清除", "0", "×" };
	}
	...
	@Override
	public CheckinViewHolder onCreateViewHolder(ViewGroup viewGroup,
			int position) {
