...
public class ToastUtil {
	...
	public static void toast(int resId) {
		Toast.makeText(KApplication.getInstance(), resId, Toast.LENGTH_SHORT)
				.show();
	}

	public static void toast(CharSequence text) {
		Toast.makeText(KApplication.getInstance(), text, Toast.LENGTH_SHORT)
				.show();
	}
	...
	public static void toastInThread(Activity activity, final int resId) {
		activity.runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				Toast.makeText(KApplication.getInstance(), resId,
	...
	public static void toastInThread(Activity activity, final CharSequence text) {
		activity.runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				Toast.makeText(KApplication.getInstance(), text,
						Toast.LENGTH_SHORT).show();
			}
		});
	}
