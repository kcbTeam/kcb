...
public class HomeActivity extends BaseFragmentActivity {
		...
		if (mCurrentFragment != nextFragment) {
			...
			if (!nextFragment.isAdded()) {
				transaction.hide(mCurrentFragment)
						.add(R.id.fragment_content, nextFragment).commit();
			} else {
	...
	public void initPopupWindow() {
		View customView = getLayoutInflater().inflate(
				R.layout.tch_popupwindow_setting, null, false);
		...
		ButtonFlat modifyButton = (ButtonFlat) customView
				.findViewById(R.id.button_modifypassword);
		...
		ButtonFlat exitButton = (ButtonFlat) customView
