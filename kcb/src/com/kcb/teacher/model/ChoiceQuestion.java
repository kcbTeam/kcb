...
public class ChoiceQuestion implements Serializable {
	...
	public ChoiceQuestion(String question, String optionA, String optionB,
			String optionC, String optionD, boolean[] correctOption) {
		mQuestion = question;
		mOptionA = optionA;
		mOptionB = optionB;
		mOptionC = optionC;
	...
	public boolean isLegal() {
		if (mCorrectId[0] == false && mCorrectId[1] == false
				&& mCorrectId[2] == false && mCorrectId[3] == false) {
			return false;
		}
		if (!mQuestion.equals("") && !mOptionA.equals("")
				&& !mOptionB.equals("") && !mOptionC.equals("")
				&& !mOptionD.equals("")) {
			return true;
		}
		return false;
