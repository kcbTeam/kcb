...
public class ListAdapterMissCheckIn extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View view = View.inflate(mContext, R.layout.tch_listitem_misscheckin,
				null);
		...
		TextView checkinDetail = (TextView) view
				.findViewById(R.id.textview_checkin_detail);
		checkinDetail.setText(String.format(FORMAT_CHECKIN_DETAIL,
				mList.get(position).getMissTimes(), mList.get(position)
						.getCheckInTimes()));
		return view;
	}
}
