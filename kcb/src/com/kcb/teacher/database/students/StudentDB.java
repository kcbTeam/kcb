...
public class StudentDB {
    ...
    public final static String TABLE_NAME = "tch_stucentre";
    ...
    public final static String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME
            + "(_id INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_NAME + " text," + KEY_STUID
            + " text," + KEY_CHECKINRATE + " text," + KEY_CORRECTRATE + " text," + KEY_STUDENT
            + " text)";
}
