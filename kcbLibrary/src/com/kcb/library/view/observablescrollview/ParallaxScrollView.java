package com.kcb.library.view.observablescrollview;
...
import com.kcb.library.view.observablescrollview.ObservableScrollView.ScrollCallbacks;
...
public class ParallaxScrollView extends ViewGroup {
    ...
    private static final int[] ParallaxScrollView = {0x7f010000};
    ...
    public ParallaxScrollView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, ParallaxScrollView, 0, 0);

        try {
            setParallaxOffset(a.getFloat(0, PARALLAX_OFFSET_DEFAULT));
     ...
     * Set the offset
     * 
     * @param offset a number greater than 0.0
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mBackground != null) {
            int minHeight = 0;
            minHeight =
                    (int) (mScrollViewHeight + mParallaxOffset
