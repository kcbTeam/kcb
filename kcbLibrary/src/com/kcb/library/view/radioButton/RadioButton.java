...
public class RadioButton extends CompoundButton {
    ...
    public RadioButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mColor =
                attributes.getColor(R.styleable.RadioButton_radio_color,
                        getResources().getColor(R.color.radio_color));
        mCheckedColor =
                attributes.getColor(R.styleable.RadioButton_radio_checked_color, getResources()
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        widthMeasureSpec =
                MeasureSpec.makeMeasureSpec(measureWidth(widthMeasureSpec), MeasureSpec.EXACTLY);
        heightMeasureSpec =
                MeasureSpec.makeMeasureSpec(measureHeight(heightMeasureSpec), MeasureSpec.EXACTLY);
        ...
        switch (mState) {
            ...
            case StateTouchUp:
                if (elapsed < ANIMATION_DURATION) {
                    ...
                    rippleRadius =
                            Math.round((ANIMATION_DURATION - elapsed) * mRippleRadius
                                    / ANIMATION_DURATION);
                    if (isChecked()) {
                        thumbRadius = Math.round(elapsed * mThumbRadius / ANIMATION_DURATION);
                    } else {
                        thumbRadius =
                                Math.round((ANIMATION_DURATION - elapsed) * mThumbRadius
                                        / ANIMATION_DURATION);
                    }
                } else {
                    mState = StateNormal;
