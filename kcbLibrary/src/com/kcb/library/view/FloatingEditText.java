...
public class FloatingEditText extends EditText {
    ...
    public FloatingEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHintScale =
                attributes.getFloat(R.styleable.FloatingEditText_floating_edit_text_hint_scale,
                        HINT_SCALE);
        mColor =
                attributes.getColor(R.styleable.FloatingEditText_floating_edit_text_color,
        ...
        mErrorColor =
                attributes.getColor(R.styleable.FloatingEditText_floating_edit_text_error_color,
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(getHint())) {
            ...
            float minHintY =
                    getBaseline() + getPaint().getFontMetricsInt().top + getScrollY() - dpToPx(4);
            float textSize;
            float hintY;
            ...
            switch (mState) {
                ...
                case StateHintZoomIn: {
                    if (elapsed < ANIMATION_DURATION) {
                        textSize =
                                ((maxTextSize - minTextSize) * elapsed) / ANIMATION_DURATION
                                        + minTextSize;
                ...
                case StateHintZoomOut: {
                    if (elapsed < ANIMATION_DURATION) {
                        textSize =
                                maxTextSize - ((maxTextSize - minTextSize) * elapsed)
                                        / ANIMATION_DURATION;
