...
public class ImageViewUtil {
     ...
     * @return the rectangular position of the Bitmap
     */
    public static Rect getBitmapRectCenterInside(int bitmapWidth, int bitmapHeight, int viewWidth,
            int viewHeight) {
        return getBitmapRectCenterInsideHelper(bitmapWidth, bitmapHeight, viewWidth, viewHeight);
    }
     ...
     * if it were placed inside a View with scale type set to {@link ImageView#ScaleType
     * #CENTER_INSIDE}.
     * 
     * @param bitmapWidth the Bitmap's width
     * @param bitmapHeight the Bitmap's height
     ...
     * @return the rectangular position of the Bitmap
     */
    private static Rect getBitmapRectCenterInsideHelper(int bitmapWidth, int bitmapHeight,
        ...
        final Rect result =
                new Rect(resultX, resultY, resultX + (int) Math.ceil(resultWidth), resultY
