 ...
 * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} during
 * image loading</li>
 * <li>whether stub image will be displayed in
 * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} if empty
 * URI is passed</li>
 * <li>whether stub image will be displayed in
 * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} if image
 * loading fails</li>
 * <li>whether {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view}
 * should be reset before image loading start</li>
 ...
 * <li>auxiliary object which will be passed to {@link ImageDownloader#getStream(String, Object)
 * ImageDownloader}</li>
...
public final class DisplayImageOptions {
    ...
    public static class Builder {
         ...
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view}
         * during image loading. This option will be ignored if
        ...
        /**
         * Incoming image will be displayed in
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} if
         * empty URI (null or empty string) will be passed to <b>ImageLoader.displayImage(...)</b>
         * method.
         * 
         * @param imageRes Image resource
         */
         ...
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} if
         * empty URI (null or empty string) will be passed to <b>ImageLoader.displayImage(...)</b>
         * method. This option will be ignored if
         ...
         * Incoming image will be displayed in
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} if
         * some error occurs during requested image loading/decoding.
         * 
         * @param imageRes Image resource
         */
         ...
         * Incoming drawable will be displayed in
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} if
         * some error occurs during requested image loading/decoding. This option will be ignored if
        ...
        /**
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view}
         * will be reset (set <b>null</b>) before image loading start
         * 
        ...
        /**
         * Sets whether {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
         ...
         * while define scale size for decoding image to Bitmap. Default value -
         ...
         * considered. Library calculate the most appropriate sample size itself according yo
         ...
         * So memory cache will contain bitmap processed by incoming preProcessor.<br />
