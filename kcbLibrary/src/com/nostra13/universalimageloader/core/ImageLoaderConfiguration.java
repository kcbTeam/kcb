...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        private static final String WARNING_OVERLAP_EXECUTOR =
                "threadPoolSize(), threadPriority() and tasksProcessingOrder() calls "
         ...
         *        saving during decoding an image to {@link android.graphics.Bitmap Bitmap}.
         ...
         *        cache
         * @param maxImageHeightForDiskCache Maximum height of downloaded images for saving at disk
         *        cache
         * @param processorForDiskCache null-ok; {@linkplain BitmapProcessor Bitmap processor} which
         *        process images before saving them in disc cache
         */
        ...
        /**
         * Sets custom {@linkplain Executor executor} for tasks of displaying <b>cached on disk</b>
         * images (these tasks are executed quickly so UIL prefer to use separate executor for
         * them).<br />
         * <br />
         * If you set the same executor for {@linkplain #taskExecutor(Executor) general tasks} and
         * tasks about cached images (this method) then these tasks will be in the same thread pool.
         * So short-lived tasks can wait a long time for their turn.<br />
         * <br />
         * <b>NOTE:</b> If you set custom executor then following configuration options will not be
         * considered for this executor:
         * <ul>
         ...
         * {@link Thread#MAX_PRIORITY} or less than {@link Thread#MIN_PRIORITY}<br />
        ...
        /**
         * When you display an image in a small {@link android.widget.ImageView ImageView} and later
         * you try to display this image (from identical URI) in a larger
         * {@link android.widget.ImageView ImageView} so decoded image of bigger size will be cached
         * in memory as a previous decoded image of smaller size.<br />
         * So <b>the default behavior is to allow to cache multiple sizes of one image in
         * memory</b>. You can <b>deny</b> it by calling <b>this</b> method: so when some image will
         * be cached in memory then previous cached size of this image (if it exists) will be
         * removed from memory cache before.
         */
         ...
         * will be used as memory cache. You can use {@link #memoryCache(MemoryCache)} method to set
         * your own implementation of {@link MemoryCache}.
         */
         ...
         * {@link android.graphics.Bitmap bitmaps}.<br />
         * Default value - 1/8 of available app memory.<br />
         * <b>NOTE:</b> If you use this method then
         * {@link com.nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
         * will be used as memory cache. You can use {@link #memoryCache(MemoryCache)} method to set
         ...
         * <br />
         * <b>NOTE:</b> If you set custom memory cache then following configuration option will not
         * be considered:
         * <ul>
         ...
         * These options will be used for every
         * {@linkplain ImageLoader#displayImage(String, android.widget.ImageView) image display
         * call} without passing custom {@linkplain DisplayImageOptions options}<br />
         ...
         * this method. Consider {@link com.nostra13.universalimageloader.utils.L#disableLogging()}
        ...
        private void initEmptyFieldsWithDefaultValues() {
            if (taskExecutor == null) {
                taskExecutor =
                        DefaultConfigurationFactory.createExecutor(threadPoolSize, threadPriority,
                                tasksProcessingType);
            } else {
                customExecutor = true;
            }
            ...
            if (diskCache == null) {
                ...
                diskCache =
                        DefaultConfigurationFactory.createDiskCache(context,
            ...
            if (denyCacheImageMultipleSizesInMemory) {
                memoryCache =
                        new FuzzyKeyMemoryCache(memoryCache,
