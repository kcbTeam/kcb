...
/**
 * ImageAware which provides needed info for processing of original image but do nothing for
 * displaying image. It's used when user need just load and decode image and get it in
