...
/**
 * Wrapper for Android {@link android.view.View View}. Keeps weak reference of View to prevent
 * memory leaks.
 * 
...
public abstract class ViewAware implements ImageAware {
     ...
     *        will check actual size of View. It can cause known issues like <a
     ...
     *        consider actual size of View, just layout parameters. <br />
    ...
    public int getHeight() {
        ...
        if (view != null) {
            ...
            if (height <= 0 && params != null) height = params.height; // Get layout height
                                                                       // parameter
            return height;
        }
        return 0;
