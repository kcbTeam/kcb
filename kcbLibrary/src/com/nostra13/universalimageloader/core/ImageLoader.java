...
public class ImageLoader {
    ...
    private static final String ERROR_WRONG_ARGUMENTS =
     ...
     * initialized with configuration}; <b>false</b> - otherwise
     */
     ...
     *        Options} for image decoding and displaying. If <b>null</b> - default display image
     *        options
     ...
     *        Listener} for image loading progress. Listener fires events on UI thread if this
     *        method is called on UI thread. Caching on disk should be enabled in
     *        {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions options} to
     *        make this listener work.
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called
     *         before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
     ...
     *        callback}. Downloaded image will be decoded and scaled to {@link Bitmap} of the size
     *        which is <b>equal or larger</b> (usually a bit larger) than incoming targetImageSize.
     * @param listener {@linkplain ImageLoadingListener Listener} for image loading process.
     *        Listener fires events on UI thread if this method is called on UI thread.
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called
     *         before
     ...
     * @param uri Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param options {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions
     *        Options} for image decoding and scaling. If <b>null</b> - default display image
     *        options
     *        {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions)
     *        from configuration} will be used.
     * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding was failed or
     ...
     *        image will be decoded and scaled to {@link Bitmap} of the size which is <b>equal or
     *        larger</b> (usually a bit larger) than incoming targetImageSize.
     * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding was failed or
     *         cancelled.
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called
     *         before
     ...
     * {@link ImageLoadingListener#onLoadingFailed(String, View, FailReason)} callback will be fired
     ...
     *        network; <b>false</b> - to allow engine to download images from network.
     */
    ...
    /**
     * Sets option whether ImageLoader will use {@link FlushedInputStream} for network downloads to
     * handle <a href="http://code.google.com/p/android/issues/detail?id=6066">this known
     * problem</a> or not.
     * 
