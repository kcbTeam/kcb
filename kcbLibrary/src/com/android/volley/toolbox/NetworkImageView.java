...
public class NetworkImageView extends ImageView {
    ...
    /**
     * Gets the URL of the image that should be loaded into this view, or null if no URL has been
     * set. The image may or may not already be downloaded and set into the view.
     * 
